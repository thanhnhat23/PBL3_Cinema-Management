...
import { EllipsisVertical, Eye, PenLine, Trash, Pizza, DollarSign, Boxes } from "lucide-react";
...
export default function LayoutSnacks() {
            ...
            case "name":
                return (
                    <div className="flex gap-3 items-center">
                        <div className="shrink-0 relative w-10 h-10 rounded-lg overflow-hidden border border-zinc-100 dark:border-zinc-800 shadow-sm">
                            <Image
                        ...
                        <span className="font-semibold text-zinc-700 dark:text-zinc-200 truncate max-w-30 sm:max-w-none" title={snack.name}>
                            {snack.name}
                        </span>
                    </div>
                );
