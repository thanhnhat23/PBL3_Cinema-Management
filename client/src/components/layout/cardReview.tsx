...
export default function CardReview ({ review, index }: DataReviewProps) {
    ...
    return (
        <Link
            ...
            key={index}
            className="w-full rounded-md shadow-md bg-neutral-100 dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-700 transition-transform hover:scale-[1.01] duration-200"
        >
            <Card>
                <CardBody className="p-4 flex flex-row gap-4 items-start">
                    <div className="h-full min-w-36">
                        <Image 
                            ...
                            width={150}
                            height={150}
                            className="object-cover w-36 h-56 rounded-md"
                        />
                    </div>
