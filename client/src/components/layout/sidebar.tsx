...
import { Button } from '@/components/ui/buttons/buttonSideBar';
import { Input } from '@/components/ui/input';
import { Separator } from '@/components/ui/effects/separator';
import { Skeleton } from '@/components/skeletons/sideBar';
import {
  Sheet,
  SheetContent,
  SheetDescription,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative w-(--sidebar-width) bg-transparent transition-[width] duration-300 ease-[cubic-bezier(0.7,-0.15,0.25,1.15)] will-change-[width]',
