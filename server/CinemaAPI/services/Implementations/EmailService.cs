    ...
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailVerificationAsync(string email, string verificationToken)
        {
            try
            {
                ...
                message.From = "MilkyWayyy Cinema <support@milkywayyy.me>";
                message.To.Add(email);
                message.Subject = "Chào mừng bạn đến với MilkyWayyy Cinema - Xác thực tài khoản";
                message.HtmlBody = $@"
                <div style=""font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;"">
                    <div style=""background-image: url(https://i.pinimg.com/1200x/9a/3d/eb/9a3deb34b6995a52e8635a6f4cbe90c2.jpg);
                                background-size: cover; 
                    ...
                    <div style=""padding: 40px 30px; background-color: #ffffff;"">
                        <h2 style=""color: #333333; margin-top: 0; text-align: center;"">Xác thực địa chỉ Email</h2>
                    ...
                    <div style=""background-color: #f4f4f4; padding: 25px; text-align: center; color: #888888; font-size: 12px;"">
                        <p style=""margin: 5px 0; font-weight: bold; color: #555555;"">© 2026 MilkyWayyy Cinema. All rights reserved.</p>
                        <p style=""margin: 5px 0;"">Đại học Bách Khoa - Đại học Đà Nẵng, Đà Nẵng, Việt Nam</p>
                    </div>
                </div>";
